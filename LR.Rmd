...
```{r content1, include=TRUE, echo=FALSE}
...
\
\
```{r content2, include=TRUE, echo=FALSE}
...
```{r content11, include=TRUE, echo=FALSE}
...
```{r content12, include=TRUE, echo=FALSE}
...
```{r content13, include=TRUE, echo=FALSE}
...
```{r content14, include=TRUE, echo=FALSE}
ames_raw %>% select(Neighborhood, `Overall Qual`) %>%
...
```{r content4, include=TRUE, echo=FALSE}
ames_raw %>% count(`Roof Matl`)
```
**▲ 지붕 재료 분포(Roof Matl)**

```{r content5, include=TRUE, echo=FALSE}
...
```{r content6, include=TRUE, echo=FALSE}
...
```{r content7, include=TRUE, echo=FALSE}
ames_raw %>% select(Neighborhood, `Roof Matl`) %>% 
...
\
\
```{r content8, include=TRUE, echo=FALSE}
...
```{r content9, include=TRUE, echo=FALSE}
...
\
\
```{r content10, include=TRUE, echo=FALSE}
...
```{r content15, include=TRUE, echo=FALSE}
...
```{r content16, include=TRUE, echo=FALSE}
